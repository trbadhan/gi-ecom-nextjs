        ...
        rows.push(
          <li
            ...
            className={`border-b border-gray-200 px-4 py-2
                      ${cat.parent_id ? "odd:bg-white even:bg-gray-50" : "bg-gray-100"}
                      ${highlightId === cat.id ? "animate-pulse bg-green-50" : ""}
                      ${cat.is_active ? "text-gray-800" : "text-gray-400 italic"}
                    `}
          >
            <div className="flex items-center justify-between">
              {/* Left: name */}
              <span className={cat.parent_id ? "font-normal pl-4" : "font-bold"}>
                {cat.name}
              </span>
              ...
              <div className="flex space-x-3 text-sm">
                <button
                  ...
                  className="text-blue-600 hover:underline" title="Edit"
                >
                  <Pencil size={18} />
                </button>
                <button
